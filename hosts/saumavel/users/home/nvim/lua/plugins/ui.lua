return {
	...
	-- Saumavel: Noice for cmdline/messages/notifications
	{
		"noice.nvim",
		event = "VeryLazy",
		after = function()
			require("noice").setup({
				lsp = {
					hover = {
						-- Don't show message if hover is not available
						silent = true,
					},
					override = {
...
╚═╝     ╚═╝  ╚═══╝  ╚═╝╚═╝     ╚═╝]],
				...
				-- Saumavel: disable animations
				animate = { enabled = false },
			})
		end,
	},

	-- Saumavel: Mini.hipatterns for Tailwind color highlighting
	{
		"mini.hipatterns",
